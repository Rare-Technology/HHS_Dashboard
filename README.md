...
Here is a the metadata associated with the dataset. Each HHS question begins with a number (1 to 83). The rest of the columns are information regarding administration levels, management levels, date of survey, submission ids, etc. The following are the column names and associated metadata:
...
"level4_id"                       
  [7] "lat"                              "lon"                             
  [9] "ma_name"                          "ma_area"                         
 [11] "ma_status"                        "reserves"                        
 [13] "reserve_status"                   "username"                        
 [15] "submissionid"                     "updatedat"                       
 [17] "startformtimestamp"               "endformtimestamp"                
 [19] "1_interviewer"                    "2_affiliation"                   
 [21] "3_community"                      "5_hh_status"                     
 [23] "6_gender"                         "8_religion"                      
 [25] "8_religion_other"                 "9_region_member"                 
 [27] "9_region_name"                    "10_mpa_important"                
