...
**12a_fishing_men**: Numeric, NA (no answered)        
**12b_fishing_women**: Numeric, NA (no answered)
**12c_fishing_children**: Numeric, NA (no answered)         
**13a_processing_men**: Numeric, NA (no answered)         
