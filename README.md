...
**44_meeting_attendance**: Factor, 5 levels, blanks or na (nor answered)        
**45_leadership_position**: Factor, 5 levels, blanks or na (nor answered)     
**46_represent_interests**: Factor, 4 levels, na (not answered)             
**47_represent_contributions**: Factor, 4 levels, na (not answered)    
**48_enforcement_participiation**:  Factor, 4 levels, blanks OR na (not answered)   
...
**69_fish_type**: Factor, many levels, open answer          
**69_street**: Integer, fish price in local currency, blanks or NA (not answered)   
**69_customer_home**: Integer, fish price in local currency, blanks or NA (not answered)    
**69_market**: Integer, fish price in local currency, blanks or NA (not answered)    
**69_shop**: Integer, fish price in local currency, blanks or NA (not answered)    
**69_fishing_company**: Integer, fish price in local currency, blanks or NA (not answered)      
**69_restaurant**: Integer, fish price in local currency, blanks or NA (not answered)     
**69_own_home**: Integer, fish price in local currency, blanks or NA (not answered)         
**69_other**: Integer, fish price in local currency, blanks or NA (not answered)      
